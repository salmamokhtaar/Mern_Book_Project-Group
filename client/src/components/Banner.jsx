  ...
  return (
    <div className='relative overflow-hidden'>
      ...
      <div className='absolute inset-0 overflow-hidden'>
        ...
        <div className='absolute top-96 -right-20 w-96 h-96 bg-secondary-light rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000'></div>
        <div className='absolute -bottom-24 left-1/2 w-96 h-96 bg-neutral-500 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000'></div>
      </div>
      ...
      <div className='px-4 lg:px-24 relative z-10'>
        <div className='flex w-full flex-col md:flex-row justify-between items-center gap-12 py-24 md:py-40'>
          {/* Left side */}
          <motion.div
            className='md:w-1/2 h-full space-y-8 text-black'
          ...
          >
            ...
            <p className='md:w-4/5 text-xl md:text-2xl text-black'>
            ...
            <form onSubmit={handleSearch} className='flex flex-col sm:flex-row gap-4 sm:gap-0'>
              ...
              <button
                type="submit"
                className='bg-secondary-color px-6 py-3 rounded-lg sm:rounded-l-none text-white font-medium shadow-lg hover:bg-secondary-dark hover:shadow-xl transition-all duration-300'
              >
                Search
              </button>
            </form>
            ...
            <div className='pt-4 flex gap-4'>
              <Link
                to="/shop"
                className='inline-block px-6 py-3 bg-primary-color text-white font-medium rounded-lg hover:bg-primary-dark transition-colors shadow-md'
              >
                Browse Books
              </Link>
              <Link
                to="/about"
                className='inline-block px-6 py-3 border-2 border-white text-white font-medium rounded-lg hover:bg-white hover:text-neutral-800 transition-colors'
              >
                Learn More
              </Link>
            </div>
