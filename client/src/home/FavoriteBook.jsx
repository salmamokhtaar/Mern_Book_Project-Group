...
import img from "../../src/assets/banner/31.jpg"
      ...
      <div className='md:w-1/2'>
        ...
        <h2 className='text-4xl font-bold my-5 md:w-3/4  leading-snug'>Find Your Favorite
         ...
         <p className='mb-10 text-lg md:w-5/6'>Lorem ipsum dolor sit amet consectetur adipisicing elit.
           Cum tempora rem molestiae nisi nam nemo delectus, magnam, 
           vitae earum ipsa eum fuga ea optio dignissimos doloremque aspernatur labore voluptatibus ducimus!</p>

          {/* book listing , register user, pdf download */}
        <div className='flex flex-col sm:flex-row justify-between  gap-6 md:w-3/4 my-14'>

          <div>
           <h3 className='text-3xl font-bold'>800+</h3>
           <p className='text-base'>Book Listining</p>
          </div>
